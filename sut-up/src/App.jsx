          ...
          <div className="section-inner section-content">
            ...
            {projectMode === "technical" && (
              <div className="project-grid">
                <div className="project-card">
                  <img src="blue-background.png" className="project-thumb" alt="AuraTune" />
                  <h3>AuraTune</h3>
                  <p className="muted">Interactive Unity-based environment for kinesiology experiments.</p>
                </div>
                <div className="project-card">
                  <img src="triage.webp" className="project-thumb" alt="TriageOS" />
                  <h3>TriageOS</h3>
                  <p className="muted">Full-stack analytics dashboard built with React + Node.</p>
                </div>
                <div className="project-card">
                  <img src="blue-background.png" className="project-thumb" alt="StudyBuds" />
                  <h3>StudyBuds</h3>
                  <p className="muted">Collaborative study platform for students.</p>
                </div>
                <div className="project-card">
                  <video className="project-thumb" autoPlay muted loop playsInline>
                  ...
                  <div className="tiktok-feed">
                    {[
                      ...
                      <div className="tiktok-card" key={tok.id}>
                        <div className="tiktok-thumb"><div className="tiktok-play">▶</div></div>
